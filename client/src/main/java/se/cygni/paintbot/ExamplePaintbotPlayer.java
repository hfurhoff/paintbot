...
public class ExamplePaintbotPlayer extends BasePaintbotClient {

    private static Logger log = LoggerFactory
            .getLogger(ExamplePaintbotPlayer.class);
...
//    private int port = 80;
    ...
    public static void main(String[] args) {
        ...
        Runnable task = () -> {
            ...
            ExamplePaintbotPlayer sp = new ExamplePaintbotPlayer();
            sp.connect();
