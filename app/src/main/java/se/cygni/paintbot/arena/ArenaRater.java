package se.cygni.paintbot.arena;
...
public class ArenaRater {
    ...
    private void calculateRating() {
        ...
        // The initial volatility is set to pretty high, to allow non competing paintbots to fall rapidly in rank
    ...
    // Unable to find a single main class from the following candidates [se.cygni.paintbot.PaintbotServerApplication, se.cygni.paintbot.arena.ArenaRater]
