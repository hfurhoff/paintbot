...
import se.cygni.paintbot.tournament.TournamentPlannedGame;
...
public class TournamentPlanConverter {
    ...
    public static List<TournamentLevel> getLevels(List<se.cygni.paintbot.tournament.TournamentLevel> levels) {
